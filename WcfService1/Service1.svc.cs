...
namespace WcfService1
{
    ...
    {
        SqlConnection con = new SqlConnection("Data source=DESKTOP-H7JUHR5;Initial Catalog=MyTestDB;Persist Security info=true;User ID=sa;Password=102314;Pooling=False");
